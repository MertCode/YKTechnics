...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
   ...
   $phone = $_POST['phone2'];
   $installation_type = $_POST['installation_type2'];
   $contact_preference = $_POST['contact_preference2'];
   $additional_info = $_POST['additional_info2']; // No sanitization for additional info
